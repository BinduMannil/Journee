...
export const platformSystems: readonly PlatformSystem[] = [
  ...
  { name: "Transport Modes", status: "scaffold", note: "Comprehensive catalog of every way to get around (metro/bus/taxi/tuk-tuk/ferry/ATV/caleche/…) + availability per destination; seed, not a live feed." },
  { name: "Tourist Item Base Prices", status: "scaffold", note: "Fair/typical USD price ranges for common tourist buys (+ bargaining-expected flag) so you know when you're overcharged; approximate, not live quotes." },
  { name: "Tourist Sites & Attractions", status: "scaffold", note: "Top sites with cost band, best time of day (light/heat/crowds) + why, busyness, typical hours, booking note (no fabricated links), experience tags; best-sites-by-experience recommender; editorial, verify official source." },
  ...
  { name: "Nightlife & Bars", status: "scaffold", note: "After-dark venues/areas (bars/clubs/live-music/rooftops/cultural evenings) with vibe + typical hours; editorial, culturally aware, not a live listings feed." },
  { name: "Beaches & Swimming Spots", status: "scaffold", note: "Beaches/lakes/pools per destination with water type, vibe + swimmable flag; honest about landlocked cities; heed local flags — not a live conditions feed." },
  { name: "Family & Kids Activities", status: "scaffold", note: "Kid-friendly activities with age-suitability + stroller-friendly flag; editorial, suitability depends on the child — verify safety/hours." },
