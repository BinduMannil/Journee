...
export const platformSystems: readonly PlatformSystem[] = [
  ...
  { name: "Tourist Sites & Attractions", status: "scaffold", note: "Top sites with cost band, best time of day (light/heat/crowds) + why, busyness, typical hours, booking note (no fabricated links); editorial, verify official source." },
